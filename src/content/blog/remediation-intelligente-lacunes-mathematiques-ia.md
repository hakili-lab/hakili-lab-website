...
- **Un diagnostic automatisé des erreurs :** L'outil identifie si la difficulté provient d'une règle de cours non maîtrisée, d'une erreur de calcul arithmétique ou d'une mauvaise lecture de l'énoncé.
- **Un parcours d'exercices progressifs :** L'élève ne perd pas de temps à refaire tout le programme : il reçoit des activités ciblées sur la compétence précise qui lui manque.
